        ...
        <>
            {isPending ? (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/35 backdrop-blur-[2px]">
                    <div className="flex items-center gap-3 rounded-2xl border border-white/15 bg-slate-950/85 px-5 py-4 text-white shadow-2xl">
                        ...
                        <div className="text-sm font-medium">Loading clients...</div>
                    </div>
                </div>
            ) : null}
            ...
            <div className="flex items-center gap-2">
                <div className="relative w-[320px] max-w-[55vw]">
                    ...
                    {showClear ? (
                        <button
                            ...
                            disabled={isPending}
                            className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-1 text-muted-foreground transition hover:cursor-pointer hover:bg-cyan-50 hover:text-cyan-700 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            <X className="h-4 w-4" />
                        </button>
                    ) : null}
                ...
                <Button
                    ...
                    onClick={clear}
                    disabled={isPending}
                    className="hidden cursor-pointer text-black transition hover:border-cyan-300 hover:bg-cyan-50 hover:text-cyan-700 disabled:cursor-not-allowed sm:inline-flex"
                >
                    Clear
                </Button>
            </div>
